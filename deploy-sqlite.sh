...
# Atlantic Leather SQLite Deployment Script
# This version uses SQLite instead of MySQL for better compatibility with low-memory VPS

set -e

echo "🚀 Atlantic Leather SQLite Deployment Script"
echo "============================================="
...
echo -e "${BLUE}Welcome to Atlantic Leather SQLite Deployment!${NC}"
echo ""
echo "This script will:"
echo "1. Install required software (Node.js, SQLite, Nginx, PM2)"
...
echo -e "${YELLOW}Step 3: Setting up SQLite database...${NC}"

# Create data directory
mkdir -p /var/www/altantis/backend/data
chmod 755 /var/www/altantis/backend/data

echo -e "${GREEN}SQLite database setup completed!${NC}"
...
echo ""
echo -e "${GREEN}🎉 SQLite Deployment completed successfully!${NC}"
echo ""
...
echo "Database: SQLite (./data/atlantic_leather.db)"
...
echo "Backup database: cp ./data/atlantic_leather.db backup_$(date +%Y%m%d_%H%M%S).db"
echo ""
echo -e "${GREEN}SQLite Deployment completed! 🚀${NC}"
